<%@ Page Language="C#" AutoEventWireup="true" CodeFile="habitacion_det3.aspx.cs" Inherits="habitacion_det3" %>
        ...
        <div class="shell">
          <div class="range range-50 range-md-center">
            <div class="cell-md-10 cell-lg-8">
              ...
              <!-- RD Mailform-->
                <form method="post" action="habitacion_det3.aspx">        
              ...
              <div class="divider"></div>
                    ...
                    <div class="form-wrap">
                        ...
                        <input class="form-input" id="cantidadPasajeros" type="number" name="cantidadPasajeros" min="1" max="4" value="1" data-constraints="@Required">
                    </div>
                    <div class="form-wrap">
