<%@ Page Language="C#" AutoEventWireup="true" CodeFile="habitacion_det.aspx.cs" Inherits="habitacion_det" %>
          ...
          <div class="range range-50 range-md-center">
            <div class="cell-md-10 cell-lg-8">
              ...
              <ul class="list-marked">
                ...
                <li>Categorias: <a href="rooms-search-results.html">Single</a></li>
              </ul>
              <div class="section-xs">
                <div class="divider"></div>
              </div>
              ...
              <!-- RD Mailform-->
                <form method="post" action="habitacion_det.aspx">    
              ...
              <div class="divider"></div>
                    <div class="form-wrap">
                        ...
                        <input class="form-input" required id="arrival" type="text" name="arrival" id="arrival" placeholder="" data-time-picker="date" data-constraints="@Required">
                    </div>
                    <div class="form-wrap">
                        <label class="form-label-outside" for="reservation-departure">Salida:*</label>
                        <input class="form-input" required id="departure" type="text" name="departure" id="departure" placeholder="" data-time-picker="date" data-constraints="@Required">
                    </div>
                    <div class="form-wrap">
                        <label class="form-label-outside" for="reservation-adults-count">Pasajeros:*</label>
                        <input class="form-input" id="cantidadPasajeros" type="number" id="cantidadPasajeros" name="cantidadPasajeros" min="1" max="2" value="1" data-constraints="@Required">
                    </div>
                    <div class="form-wrap">
                        <h4>Codigo Convenios Empresas:</h4>
                        <label class="form-label-outside" for="contact-first-name">Codigo Convenio:</label>
                        <input class="form-input" id="codigoConvenio" type="text" id="codigoConvenio" name="codigoConvenio" placeholder="evJH948U">
                    </div>
                        <div class="divider"></div>
                        <input type="submit" class="button button-primary" value="Reservar">
                </form>
            </div>
          </div>
      </section>
